...
char* Tipos_Fumador[3] = { "Cerillas & Tabaco", "Cerillas & Papel", "Tabaco & Papel" };								/* Se trata de una matriz de cadenas que describe lo que necesita cada tipo de fumador*/

bool Elementos_Mesa[3] = { false, false, false }; 																	/*Esta lista representa los tipos de elementos que están en la mesa. Esto debería corresponde
																													Con los Tipos_Fumador, de manera que cada elemento es la que el fumador tiene. Así que el primer 
																													elemento sería papel y tabaco, a continuación, coincide*/

/*Funciones*/ 

/**
* Función fuma, maneja la espera de que necesitan del elemento y, a continuación,
* Fuman. Repita esto tres veces
*/
...
/**
* El Productor es responsable de liberar el semáforo Fumador adecuado cuando el artículo
* correctos están en la mesa
*/
...
int main(int argc, char* arvg[]){
	...
	sem_init(&Agente_Listo, 0, 1); 																					/*Sólo hay un semáforo agente ya que sólo un conjunto de artículos puede ser en la mesa 
																													en cualquier momento dado. A valores de 1 = nada en la mesa*/
	...
	pthread_t Hebra_Fumador[6];
	pthread_t Hebra_Productor[6];
	pthread_t Hebra_Agente[6];
