...
void entrar_tienda() 						{printf("Un cliente ha entrado en la tienda\n");}
void sentarse_sofa() 						{printf("Un cliente se ha sentado en el sofa\n");}
void levantarse_sofa() 						{printf("Un cliente se ha levantado del sofa\n");}
void poner_cola(int numero_cliente)			{printf("El cliente %d tiene el turno\n",numero_cliente);}
void levantarse_silla_barbero() 			{printf("Un cliente se ha levantado de la silla del barbero\n");}
void salir_tienda() 						{printf("Un cliente ha salido de la tienda\n");}
void sacar_cola(int numero_cliente) 		{printf("El cliente %d ya no tiene el turno\n",numero_cliente);}
void cortar_pelo() 							{printf("Un cliente se está cortando el pelo\n");}
void aceptar_pago() 						{printf("Un cliente ha pagado su corte de pelo\n");}
void Pagar()								{printf("Un cliente está pagando\n");}
